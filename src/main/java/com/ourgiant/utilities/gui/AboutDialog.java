...
import com.ourgiant.utilities.util.NetworkFetchException;
...
final class AboutDialog extends JDialog {
    ...
    AboutDialog(Frame parent, UpdateChecker.ReleaseInfo knownNewerRelease) {
        super(parent, "About JSON Viewer", knownNewerRelease == null);
    ...
    private static String buildHtml(String currentVersion) {
        return """
            ...
            <h2 style="margin-top: 0;">JSON Viewer</h2>
            <p>Version %s</p>
            <p>A Swing desktop application for viewing, formatting, and linting
            JSON documents, with syntax highlighting and one-click
            pretty-printing or minification.</p>
            <p>&copy; OurGiant</p>
            </body></html>
