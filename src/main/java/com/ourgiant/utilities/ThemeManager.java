 ...
 * Ported from kiro-control-panel/aws-idp-saml-ui, which validated this approach
 * (including the Nimbus-flush and displayable-window-only refresh workarounds) in production.
 */
